                ...
                ->arrayNode('sftp')
                    ->canBeEnabled()
                        ->children()
                            ...
                            ->scalarNode('root')->defaultValue('/')->end()
                            ->integerNode('permPublic')->defaultNull()->min(0)->max(0777)->end()
                            ->integerNode('permPrivate')->defaultNull()->min(0)->max(0777)->end()
                            ->integerNode('directoryPerm')->defaultNull()->min(0)->max(0777)->end()
                    ->end()
                ->end()
                ->arrayNode('aws_s3_v3')
                    ->canBeEnabled()
                            ...
                            ->arrayNode('options')
                                ...
                                ->beforeNormalization()
                                    ...
                                    ->then(function ($v) {
                                        ...
                                        return array_filter($v, static function ($value) {
